...
struct jobqueue{
	...
	struct bsem *has_jobs;                      /* flag as binary semaphore  */
...
int thpool_add_work(struct thpool_* thpool_p, void (*function_p)(void*, void*), void* arg_p, void* arg_p2){
	struct job* newjob;
